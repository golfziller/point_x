...
class _ProductClient implements ProductClient {
  ...
  @override
  Future<List<ProductCategoryResponse>> getProductCategory() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductCategoryResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/products/categories',
    ...
    late List<ProductCategoryResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
